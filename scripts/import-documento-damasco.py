#!/usr/bin/env python3
"""Convierte la selección española local del Documento de Damasco a JSON."""
import json, re, sys
...
work = {
    "id": "documento-damasco-es", "title": "Documento de Damasco", "language": "es",
    ...
    "sourceUrl": "../pdfs/documento-damasco.pdf",
    "scopeNote": "Selección local de ocho capítulos procedente de las copias del Cairo y Qumrán; la versificación es editorial para lectura y búsqueda.",
    "chapters": chapters,
}
